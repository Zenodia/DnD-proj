...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/ubuntu/DnD-proj/.claude/.gsd-surface.json`
(sibling to `/home/ubuntu/DnD-proj/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/ubuntu/DnD-proj/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/ubuntu/DnD-proj/.claude/skills`).
...
`/home/ubuntu/DnD-proj/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/ubuntu/DnD-proj/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/ubuntu/DnD-proj/.claude/.gsd-surface.json`
Install profile marker: `/home/ubuntu/DnD-proj/.claude/.gsd-profile`
Skill dirs: `/home/ubuntu/DnD-proj/.claude/skills/gsd-*/`
Engine module: `/home/ubuntu/DnD-proj/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/home/ubuntu/DnD-proj/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
