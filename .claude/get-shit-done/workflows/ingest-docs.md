...
```bash
INIT=$(node "/home/ubuntu/DnD-proj/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/ubuntu/DnD-proj/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
