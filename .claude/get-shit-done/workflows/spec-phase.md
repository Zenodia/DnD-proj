...
```bash
INIT=$(node "/home/ubuntu/DnD-proj/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/ubuntu/DnD-proj/.claude/get-shit-done/templates/spec.md.
