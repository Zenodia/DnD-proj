...
```markdown
Read /home/ubuntu/DnD-proj/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/ubuntu/DnD-proj/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/ubuntu/DnD-proj/.claude/agents/gsd-ui-checker.md for instructions.
