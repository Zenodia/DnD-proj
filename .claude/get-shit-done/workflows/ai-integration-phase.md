...
<required_reading>
@/home/ubuntu/DnD-proj/.claude/get-shit-done/references/ai-frameworks.md
@/home/ubuntu/DnD-proj/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/ubuntu/DnD-proj/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/ubuntu/DnD-proj/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/ubuntu/DnD-proj/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/ubuntu/DnD-proj/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/ubuntu/DnD-proj/.claude/agents/gsd-eval-planner.md for instructions.
