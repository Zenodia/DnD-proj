...
INSTALL_JS_GLOBAL="/home/ubuntu/DnD-proj/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/ubuntu/DnD-proj/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
