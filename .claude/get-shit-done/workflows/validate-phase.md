...
```
Agent(
  prompt="Read /home/ubuntu/DnD-proj/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/ubuntu/DnD-proj/.claude/get-shit-done/templates/VALIDATION.md`
