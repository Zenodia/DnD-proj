...
```
Agent(
  prompt="Read /home/ubuntu/DnD-proj/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/ubuntu/DnD-proj/.claude/get-shit-done/templates/SECURITY.md`
