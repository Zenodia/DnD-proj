...
Reference full template: `/home/ubuntu/DnD-proj/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/ubuntu/DnD-proj/.claude/get-shit-done/templates/state.md`.
