...
<reference>
@/home/ubuntu/DnD-proj/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/ubuntu/DnD-proj/.claude/get-shit-done/references/user-profiling.md` to load:
